...
echo    '<input type="hidden" name="sql[]" value="DELETE FROM 2017teamdetail where year(date) = '. $year .' and gameid = '. $gameid .';">';
echo    '<input type="hidden" name="sql[]" value="DELETE FROM teamstats where year = '. $year .' and gameid = '. $gameid .';">';
echo    '<input type="hidden" name="sql[]" value="DELETE FROM 2017playerdetail where year(date) = '. $year .' and gameid = '. $gameid .';">';
