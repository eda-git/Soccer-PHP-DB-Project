...
<div class="card">
<form id="teamcreator" action="post_team.php" method="post">
...
<br>
 <script src="../tournamentsuite/js/jscolor.js"></script>

Color: <input type="text" class="jscolor" name="color" value="000000">
<input type='submit'>
