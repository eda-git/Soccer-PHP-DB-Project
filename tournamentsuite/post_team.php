...
<br>
Team Abbreviation: <input type="text" name="abbreviation">
<br>
...
<br>
*/
$imageshortening = str_replace(' ', '', $_POST['team']);
$imageshortening = strtolower($imageshortening);
$team = "'" . $_POST['team'] . "'";
...
$league = "'" . $_POST['league']  . "'";
$image = "'" . $imageshortening  . "'";
$color = "'#" . $_POST['color']  . "'";
$value = "(" . $team . "," . $abbreviation . "," . $city . "," . $state . "," . $stadium . "," . $league . "," . $image . "," . $color . ")";
echo '<form id="teamcreator" target="_blank" action="sql.php" method="post">';
echo '<input type="hidden" name="sql[]" value="INSERT INTO 2017teams VALUES ' . $value . '">'; 
